...
<head>
  ...
  <!-- Boostrap core CSS-->
  <link href="{{url('theme-sbadmin/vendor/boostrap/css/boostrap.min.cs')}}s" rel="stylesheet">
...
<body id="page-top">
 ...
 @include('admin.navbar')
  ...
  <script type="text/javascript" src="{{url('theme-sbadmmin/js/navbar-nav.js')}}"></script>
 @stack('js')
