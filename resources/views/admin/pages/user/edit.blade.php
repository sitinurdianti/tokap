			...
			<div class="card">
				...
				<div class="card-body">
					...
					<div class="form-group form-label-group">
 					...
 					name="akses">
 					<option value="" {{ $val==""?'seelected':'' }}>Pilih Akses Sebagai :</option>
 					<option value="Operator"  {{ $val=="operator"?'seelected':'' }}>Operator</option>
 					<option value="admin"  {{ $val=="admin"?'seelected':'' }}>Administrator</option>
 					</select>
 					@if($errors->has('akses'))
